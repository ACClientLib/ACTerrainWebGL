...
const style = `
.ac-examine-window{position:fixed;left:20px;top:20px;z-index:2100;width:310px;height:400px;overflow:hidden;isolation:isolate;color:#fff;font:13px "Times New Roman",serif;box-shadow:0 2px 12px #000}
