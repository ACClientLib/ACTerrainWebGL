...
export function createSceneView(
  ...
  const snapshot: SceneView = {
    ...
    fog: Object.freeze({
      ...fog,
      color: Object.freeze([...fog.color]) as readonly [number, number, number],
    }),
    lighting: Object.freeze({
      ...lighting,
      direction: Object.freeze([...lighting.direction]) as readonly [
        number,
        number,
        number,
      ],
      sunlight: Object.freeze([...lighting.sunlight]) as readonly [
        number,
        number,
        number,
      ],
      ambient: Object.freeze([...lighting.ambient]) as readonly [
        number,
        number,
        number,
      ],
